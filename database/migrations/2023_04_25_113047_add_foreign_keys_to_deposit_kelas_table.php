...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('deposit_kelas', function (Blueprint $table) {
            $table->foreign(['id_promo_kelas'], 'deposit_kelas_ibfk_3')->references(['id_promo_kelas'])->on('promo_kelas');
            $table->foreign(['id_pegawai'], 'deposit_kelas_ibfk_2')->references(['id_pegawai'])->on('pegawai');
